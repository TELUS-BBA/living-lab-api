...
def add_to_nanopi_group(sender, instance, created, **kwargs):
    if created:
        try:
            ...
            jitterpermission = Permission.objects.get(name='Can add jitter result')
            ...
            g.permissions.add(iperf3permission, jitterpermission, pingpermission, sockperfpermission)
